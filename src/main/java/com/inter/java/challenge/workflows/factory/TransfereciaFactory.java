...
public class TransfereciaFactory {
    ...
    public Transferencia criar(TransferirDinheiro comando, CotacaoDolar cotacao, BigDecimal valorDolar, LocalDateTime agora) {
        ...
        transferencia.setValorReal(comando.valorReal());
        transferencia.setValorDolar(valorDolar);
